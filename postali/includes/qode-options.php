...
class Qode_Theme_Options {
	...
	function qode_generate_options_page() {
		...
		<div id="qode-metaboxes-general" class="wrap">
		    ...
		    <h2 style="padding-top:25px;"><?php printf( __('version %1$s', 'qode'), '1.9.1' ); ?></h2>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_passage[enable_linkedin]">
										<option <?php if(isset($options['enable_linkedin'])){ $enable_google_plus = $options['enable_linkedin']; if ($enable_google_plus == "no") { echo "selected='selected'"; } } ?> value="no">No</option>
										<option <?php if(isset($options['enable_linkedin'])){ $enable_google_plus = $options['enable_linkedin']; if ($enable_google_plus == "yes") { echo "selected='selected'"; } } ?> value="yes">Yes</option>
									</select>
								</div>
								<div class="inline" style="width: 600px;">
									<?php esc_html_e('Share Icon', 'qode'); ?>
									<input type="text" id="google_plus_icon" name="qode_options_passage[linkedin_icon]" class="linkedin_icon" value="<?php if (isset($options['linkedin_icon'])) { echo esc_attr($options['linkedin_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Email Share', 'qode'); ?></td>
							<td>
								<div class="inline">
									<?php esc_html_e('Enable Email Share', 'qode'); ?>
									<select name="qode_options_passage[enable_email]">
										<option <?php if(isset($options['enable_email'])){ $enable_email = $options['enable_email']; if ($enable_email == "no") { echo "selected='selected'"; } } ?> value="no">No</option>
										<option <?php if(isset($options['enable_email'])){ $enable_email = $options['enable_email']; if ($enable_email == "yes") { echo "selected='selected'"; } } ?> value="yes">Yes</option>
									</select>
								</div>
								<div class="inline" style="width: 600px;">
									<?php esc_html_e('Share Icon', 'qode'); ?>
									<input type="text" id="email_icon" name="qode_options_passage[email_icon]" class="email_icon" value="<?php if (isset($options['email_icon'])) { echo esc_attr($options['email_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
