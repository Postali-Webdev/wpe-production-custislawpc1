	...
	if(isset($qode_options_passage['enable_social_share']) && $qode_options_passage['enable_social_share'] == "yes") { 
		...
		if(isset($qode_options_passage["post_types_names_$post_type"])) {
			...
			if($post_type == "portfolio_page") {
				...
				$html .= '<p class="social_share_title">SHARE</p>';
					$html .= '<ul>';
					if(isset($qode_options_passage['enable_facebook_share']) &&  $qode_options_passage['enable_facebook_share'] == "yes") { 
						...
						if($qode_options_passage['enable_twitter_share'] == "yes") { 
						 ...
						 if($qode_options_passage['enable_linkedin'] == "yes") { 
							$html .= '<li  class="linkedin_share">';
							$html .= '<a href="#" onclick="popUp=window.open(\'https://www.linkedin.com/shareArticle?mini=true&amp;url=' . urlencode(get_permalink()) . '\', \'popupwindow\', \'scrollbars=yes,width=800,height=400\');popUp.focus();return false">';
									if(!empty($qode_options_passage['linkedin_icon'])) { 
										$html .= '<img src="' . $qode_options_passage['linkedin_icon'] . '" />';
									} else { 
										$html .= '<span class="social_image"><span class="social_image_inner"></span></span>';
									 } 
									// $html .= "<span class='share_text'>" . __('Share','qode') . "</span>";
						 ...
						 if($qode_options_passage['enable_email'] == "yes") { 
							$html .= '<li class="email_share">';
							$html .= '<a title="' . get_the_title() . '" href="mailto:?subject=' . get_the_title() . '&amp;body=' . get_permalink() . '" target="_self" aria-label="Share by E-Mail">';
									if(!empty($qode_options_passage['email_icon'])) { 
										$html .= '<img src="' . $qode_options_passage['email_icon'] . '" />';
									} else { 
										$html .= '<span class="social_image"><span class="social_image_inner"></span></span>';
									 } 
									// $html .= "<span class='share_text'>" . __('Share','qode') . "</span>";
