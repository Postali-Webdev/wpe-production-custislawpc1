...
$args = array(
	'id_form' => 'commentform',
	'id_submit' => 'submit',
	'title_reply'=>'<h5>'. __( 'Share Your Thoughts','qode' ) .'</h5>',
	'title_reply_to' => __( 'Leave a Reply to %s','qode' ),
	'cancel_reply_link' => __( 'Cancel Reply','qode' ),
	'label_submit' => __( 'SUBMIT','qode' ),
	'comment_field' => '<textarea id="comment" placeholder="'.__( 'Enter your comment here...','qode' ).'" name="comment" cols="45" rows="8" aria-required="true"></textarea>',
